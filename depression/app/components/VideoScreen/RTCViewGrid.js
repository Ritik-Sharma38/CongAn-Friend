...
export default ({streams}) => {
  const RTCViewRendered = ({userId, stream}) => {
    if (stream) {
      console.log("........object url....",xyz)
      videoVariable = streams[1].stream
      console.log("streams............", stream, "streams.......", streams[1], streams[1].stream, streams)
      console.log("....remote streams url......", stream.toURL())
      console.log("....local stream url........", videoVariable.toURL())
      return (
        <RTCView
          objectFit="cover"
