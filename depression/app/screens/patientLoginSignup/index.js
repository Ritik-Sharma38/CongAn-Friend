...
class PatientLoginSignup extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {/**<TapGestureHandler onHandlerStateChange={this.onStateChange}>**/}
          <TouchableOpacity onPress={() => this.props.fbSignin("patient")}>
            <Animated.View
            style={{
              ...styles.button,
        ...
        {/**</TapGestureHandler>**/}
        {/** <TapGestureHandler onHandlerStateChange={this.onStateChange}>**/}
        <TouchableOpacity onPress={() => this.props.googleSignin("patient")}>
            <Animated.View
              style={{
                ...styles.button,
                opacity: this.buttonOpacity,
        ...
        {/**</TapGestureHandler>**/}
          ...
          >
            ...
            <TouchableOpacity onPress={() => this.props.emailSignup(this.state.email, this.state.password, "patient")}>
              <Animated.View style={styles.Lbutton}>
                <Text Style= {{ fontsize: 20, fontWeight: 'bold' }}>SIGN IN</Text>
              </Animated.View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.props.emailLogin(this.state.email, this.state.password, "patient")}>
...
export default connect(mapState,mapDispatch)(PatientLoginSignup)
