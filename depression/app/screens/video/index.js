...
import { View, StyleSheet, NativeModules, ScrollView, Text, Dimensions, Button, TouchableOpacity } from 'react-native';
...
class Video extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      appid: '34f0ee59b86a4fb295ddf82332a459c6',                   //Enter the App ID generated from the Agora Website
      channelName: 'ritik',        //Channel Name for the current session
