...
import { StyleSheet, Button, ProgressBarAndroid, Text, TextInput, View } from 'react-native';
...
class SurveyScreen extends Component {
    ...
    onSurveyFinished(answers) {
        ...
        this.props.avatarFormUpload(uid, answersAsObj);
    }
...
const mapState = (state) => ({
  ...
  backtoProfile: state.auth.backtoProfile,
})

const mapDispatch = { avatarFormUpload };
export default connect(mapState,mapDispatch)(SurveyScreen)
